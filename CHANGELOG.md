...
- ✨ **Feature**: enhance DimmableLight:turnOn to support scene activation
...
- ✨ **Feature**: add cooldown mechanism for handling consecutive 429 errors in engine.lua
...
- ✨ **Feature**: implement request coalescing for resource refresh to optimize bridge communication
...
- ✨ **Feature**: enhance brightness handling for grouped lights to prevent stale updates
...
- ✨ **Feature**: update brightness handling for grouped lights to improve user experience
...
- ✨ **Feature**: add brightness resynchronization for grouped lights to improve reliability
...
- 🐛 **Fix**: recompute average brightness in defClasses to handle dimming events correctly
...
- 🐛 **Fix**: correct proxy configuration comment in Yahue.lua
...
- ✨ **Feature**: update version to 0.2.22 and enhance room/zone class selection in devices.lua docs: add release notes for v0.2.21 with installation and usage instructions
  - Co-authored-by: Copilot <copilot@github.com>
...
- ✨ **Feature**: update version to 0.2.19 and enhance debug logging in devices.lua
  - Co-authored-by: Copilot <copilot@github.com>
...
- ✨ **Feature**: update version to 0.2.17 and increment uiVersion in devices.lua
  - Co-authored-by: Copilot <copilot@github.com>
...
- ✨ **Feature**: update version to 0.2.16 and improve uiVersion handling in devices.lua
  - Co-authored-by: Copilot <copilot@github.com>
...
- ✨ **Feature**: update version to 0.2.13 and implement huePUT request throttling
  - Co-authored-by: Copilot <copilot@github.com>
...
- ✨ **Feature**: update version to 0.2.12 and improve error handling in event stream processing
  - Co-authored-by: Copilot <copilot@github.com>
...
- ✨ **Feature**: Add release notes and forum post helper for v0.1.2
...
- ✨ **Feature**: Add release notes and forum post helper for v0.1.1
...
- ✨ **Feature**: Add release notes and forum post helper for v0.0.77
...
- ✨ **Feature**: Add release notes and forum post helper for v0.0.76
